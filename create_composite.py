...
def make_composite(img1,img2,img3,img4):
	...
	pic1 = pic1.resize((128, 128), Image.ANTIALIAS)
	pic2 = pic2.resize((128, 128), Image.ANTIALIAS)
	pic3 = pic3.resize((128, 128), Image.ANTIALIAS)
	pic4 = pic4.resize((128, 128), Image.ANTIALIAS)
